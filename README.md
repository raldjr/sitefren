...
**Alpha 0.2.4** · **PHP 8.2+** · **AGPL-3.0-only**

[Download sitefren.php](https://github.com/raldjr/sitefren/releases/download/v0.2.4/sitefren.php)
...
- Switch between focused Chat and Editor workspaces on desktop and phones.
- Install Sitefren on your home screen as a PWA; editing and publishing require internet.
...
1. [Download sitefren.php](https://github.com/raldjr/sitefren/releases/download/v0.2.4/sitefren.php). If your browser displays source, save the raw file as `sitefren.php`.
